...
export default {
  ...
  "sidebar.assistant": "Assistente",
  "sidebar.experts": "Especialistas",
  ...
  "placeholder.experts.description": "Especialistas são agentes com identidade e metodologia próprias. Monte uma equipe de especialistas para que vários papéis colaborem no seu trabalho.",
  "placeholder.projects.description": "Projetos reúnem tarefas, sessões e arquivos relacionados em um só lugar, mantendo o trabalho organizado do início ao fim.",
  "placeholder.inspiration.description": "Inspiração transforma um resultado concluído em um modelo reutilizável com um clique, para reproduzir o mesmo trabalho rapidamente.",
