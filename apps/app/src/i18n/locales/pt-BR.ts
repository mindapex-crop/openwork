...
export default {
  ...
  "settings.group_tools": "Ferramentas",
  ...
  "settings.tab_description_backend": "Inspecione provedores, agentes CLI e modelos expostos pelo mecanismo local do OpenWork.",
  "settings.tab_description_space": "Gerencie os planos, tarefas, ativos e configurações de espaço deste workspace.",
