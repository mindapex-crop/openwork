...
export default {
  ...
  "placeholder.coming_soon": "即将上线",
  "placeholder.experts.description": "专家是带方法论的智能体身份：一个专家即一种角色和方法。组建专家团，让多个角色协同完成你的工作。",
  "placeholder.projects.description": "项目把相关的任务、会话和文件汇聚在一处，让工作从开始到结束都井井有条。",
  "placeholder.inspiration.description": "灵感让你把一个完成的成果一键复刻：看到满意的作品，一键做成同款。",
