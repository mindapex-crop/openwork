...
export default {
  ...
  "composer.extensions_unavailable": "未启用扩展。请前往扩展设置启用。",
  "composer.no_plugins": "未导入插件文件。",
  "composer.plugins_unavailable": "插件文件不可用。",
  "composer.preparing_tools": "正在准备连接的服务工具…",
  "composer.placeholder": "今天帮你做些什么？@引用文件，/调用技能与指令",
  ...
  "settings.tab_backend": "后端管理",
  "settings.tab_space": "空间管理",
  ...
  "settings.tab_description_backend": "查看本地OpenWork引擎暴露的提供商、CLI代理和模型。",
  "settings.tab_description_space": "管理工作区的计划、任务、资产和空间设置。",
  ...
  "workspace_list.spaces": "空间",
  "workspace_list.admin": "管理",
