...
export default {
  ...
  "session.previous_7_days": "Previous 7 Days",
  "session.older": "Older",
  ...
  "settings.tab_description_backend": "Inspect providers, CLI agents and models exposed by the local OpenWork engine.",
  "settings.tab_description_space": "Manage this workspace's plans, tasks, assets and space settings.",
