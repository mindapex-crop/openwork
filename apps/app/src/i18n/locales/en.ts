...
export default {
  ...
  "spreadsheet.sum": "SUM",
  "spreadsheet.average": "AVG",
  "spreadsheet.min": "MIN",
  "spreadsheet.max": "MAX",
  "spreadsheet.count": "COUNT",
  "spreadsheet.circular_ref_error": "#CIRCULAR!",
  "csv_import.cancel": "Cancel",
  "csv_import.column_mapping": "Column Mapping Preview",
  "csv_import.column_mapping_desc": "Preview and map your columns",
  "csv_import.delimiter": "Delimiter",
  "csv_import.final_preview": "Final Preview & Import",
  "csv_import.final_preview_desc": "Review data before importing",
  "csv_import.import": "Import",
  "csv_import.import_button": "Import",
  "csv_import.import_options": "Import Options",
  "csv_import.import_options_desc": "Configure parsing options",
  "csv_import.live_preview": "Live Preview",
  "csv_import.rows_to_import_one": "{count} row to import",
  "csv_import.rows_to_import_other": "{count} rows to import",
  "csv_import.select_file": "Select File",
  "csv_import.select_file_desc": "Choose a CSV or TSV file to import",
  "csv_import.skip_header_row": "Skip header row",
  "csv_import.supported_formats": "Supported formats: CSV, TSV",
  ...
  // Composer "+" menu: reference experts (agents) and IM connectors.
  "composer.connector_connected": "Connected · available as a delivery target",
  "composer.connector_not_connected": "Not connected · set it up on the connectors page",
  "composer.connectors_label": "Connectors",
  "composer.expert_skill_count": "{count} skills bound",
  "composer.experts_label": "Agents",
  "composer.library_label": "Library",
  "composer.manage_connectors": "Manage connectors",
  "composer.manage_experts": "Manage agents",
  "composer.no_experts": "No agents available",
  "composer.remove_capability": "Remove reference",
  ...
  "composer.stop": "Stop",
  "composer.tools_label": "Agents, skills, connectors, and commands",
  "composer.add_label": "Add",
  "composer.attach_menu_item": "Attach files",
  "composer.record_screen": "Record screen",
  "composer.record_screen_hint": "Capture your screen and attach the recording to this task",
  "composer.goal_slash_desc": "Set or report a persistent goal for this session",
  "composer.goal_chip_title": "Session goal (click to clear)",
  "composer.goal_set": "Goal set: {goal}",
  "composer.goal_set_budget": "Goal set: {goal} - budget {turns} turns",
  "composer.goal_cleared": "Session goal cleared",
  "composer.goal_completed": "Goal marked complete; it no longer steers this session",
  "composer.goal_blocked": "Goal marked blocked; the agent will report what it needs instead of pushing on",
  "composer.goal_resumed": "Goal resumed",
  "composer.goal_blocked_by_budget": "Turn budget spent on goal \"{goal}\". The agent will summarise what it needs before continuing.",
  "composer.goal_usage": "Usage: /goal <outcome> [in N turns] | /goal | /goal complete | /goal block | /goal resume | /goal clear",
  "composer.goal_no_active": "No session goal to update. Set one with /goal <outcome>",
  "composer.goal_status_active": "Goal: {goal} - turns {progress}",
  "composer.goal_status_complete": "Goal: {goal} - complete",
  "composer.goal_status_blocked": "Goal: {goal} - blocked (turns {progress})",
  ...
  "composer.voice_input": "Voice input",
  "composer.voice_input_error": "Voice input failed. Please try again.",
  "composer.voice_input_listening": "Listening… click to stop",
  "composer.auto_mode": "Auto",
  "composer.auto_mode_hint": "Toggle auto mode",
  "tts.read_aloud": "Read",
  ...
  // Automations page — template gallery, quick create, test run
...
"sidebar.skills": "Skills",
  ...
  "collab.cursor_indicator": "{name}'s cursor",
  ...
  "task_mode.ask": "Ask",
  "task_mode.ask_desc": "Quick answers and explanations.",
  "task_mode.ask_readonly_hint": "Ask mode is read-only: it answers and explains, but won't modify files.",
  "task_mode.craft": "Craft",
  "task_mode.craft_desc": "Build or change things end-to-end.",
  "task_mode.plan": "Plan",
  "task_mode.plan_desc": "Draft a plan before running anything.",

  "quick_cmd.loop": "Loop",
  "quick_cmd.watch": "Watch",
  "quick_cmd.site": "Preview",
  "quick_cmd.record": "Record",
  ...
  "im_connectors.description": "Connect OpenWork Agent to messaging platforms so team members can chat with the Agent in their daily conversations.",
  ...
  "im_connectors.platform_feishu": "Feishu",
  "im_connectors.platform_feishu_desc": "Receive messages, create tasks and reply through a Feishu bot.",
  "im_connectors.platform_wecom": "WeCom",
  "im_connectors.platform_wecom_desc": "Connect a WeCom app and start agent sessions in internal groups.",
  "im_connectors.platform_dingtalk": "DingTalk",
  "im_connectors.platform_dingtalk_desc": "Push artifacts to DingTalk group chats and work notifications.",
  "im_connectors.platform_slack": "Slack",
  "im_connectors.platform_slack_desc": "Talk with the OpenWork agent in a Slack channel.",
  "im_connectors.platform_discord": "Discord",
  "im_connectors.platform_discord_desc": "Discord bot integration: create a dedicated skill channel.",
  ...
  "settings.tab_im_connectors": "IM Connectors",
  "settings.tab_description_im_connectors": "Connect OpenWork to Feishu, WeCom, DingTalk, Slack and other messaging platforms",
  "settings.tab_notifications": "Notifications",
  "settings.tab_description_notifications": "Notification preferences and reminders",
  "settings.tab_about": "About",
  "settings.tab_description_about": "Version info, update checks and feedback",
  ...
  "projects.new_project_desc": "Create a new local project (stored on this device). WorkBuddy-style: a Project breaks down into Plans, and each Plan contains Tasks.",
  ...
  "projects.no_projects": "No projects yet. Create your first project above.",
  ...
  "projects.tasks_other": "{count} tasks",
  "projects.tasks": "{count} tasks",
  "projects.tasks_done_one": "{count} done",
  "projects.tasks_done_other": "{count} done",
  "projects.tasks_done": "{count} done",
  "projects.no_activity": "No activity yet",
  "projects.last_activity": "Last activity · {title}",
  "projects.col_todo": "Todo",
  "projects.col_in_progress": "In progress",
  "projects.col_review": "Review",
  "projects.col_done": "Done",
  "projects.evidence": "Evidence",
  "projects.evidence_pending": "Pending",
  "projects.evidence_passed": "Passed",
  "projects.evidence_failed": "Failed",
  "projects.evidence_notes_placeholder": "Evidence notes (no roll handles)",
  "projects.evidence_approved_at": "Approved {date}",
  "projects.remove_task": "Remove task",
  "projects.move_task_to": "Move task to plan",
  "projects.plans_title": "Plans",
  "projects.plans_title_desc": "Organize tasks into plans",
  "projects.add_plan": "Add plan",
  "projects.plan_desc_placeholder": "Plan description (optional)",
  "projects.no_plans": "No plans yet",
  "projects.plan_open": "Open",
  "projects.plan_active": "Active",
  "projects.plan_done": "Done",
  "projects.remove_plan": "Remove plan",
  "projects.board_title": "Task Board",
  "projects.board_title_desc": "Track task progress across stages",
  "projects.board_for_plan": "Plan: {plan}",
  "projects.no_plans_hint": "Create a plan to start adding tasks",
  "projects.task_placeholder": "Add task",
  "projects.add_task": "Add task",
  "projects.project_not_found": "Project not found",
  "projects.delete_project": "Delete project",
  "projects.assignee_placeholder": "Assignee (agent role)",
  "projects.toggle_subtask": "Toggle subtask",
  "projects.remove_subtask": "Remove subtask",
  "projects.add_subtask": "Add subtask",
  "projects.subtasks_done": "{done}/{total} subtasks done",
  ...
  "projects.tab_tasks": "Tasks",
  "projects.tab_activity": "Activity",
  "projects.tab_plans": "Plans",
  "projects.tab_assets": "Assets",
  "projects.activity_empty": "No activity yet",
  "projects.activity_task_created": "{date} created task “{title}”",
  "projects.activity_task_done": "{date} completed task “{title}”",
  "projects.activity_task_evidence": "{date} approved task “{title}”",
  "projects.activity_plan_created": "{date} created plan “{title}”",
  "projects.activity_plan_done": "{date} completed plan “{title}”",
  "projects.assets_empty": "No assets yet",
  "projects.assets_desc": "Project deliverables and approved artifacts, managed in one place.",
  "projects.assets_table_name": "Name",
  "projects.assets_table_type": "Type",
  "projects.assets_table_status": "Status",
  "projects.assets_table_updated": "Updated",
  "projects.assets_type_task": "Task",
  "projects.assets_type_evidence": "Evidence",
  "projects.plans_view_desc": "Overall progress overview of the plans.",
  "projects.plans_progress": "{done}/{total} done",
  "projects.activity_filter_all": "All",
  "projects.activity_filter_mine": "Related to me",
  "projects.activity_filter_member": "Member activity",
  "projects.activity_filter_automation": "Automation",
  "projects.activity_member_joined": "{date} member \"{title}\" joined the project",
  "projects.activity_automation_run": "{date} automation ran \"{title}\"",
  "projects.members_add": "Add member",
  "projects.members_invite_link": "Invite link generated. Copy and share it with members.",
  "projects.members_empty": "No members yet",
  "projects.members_role_owner": "Owner",
  "projects.members_role_member": "Member",
  "projects.task_package_desc": "Package deliverables, progress summary, and custom fields to transfer this task to another project.",
  "projects.task_package_action": "Package & transfer",
  "projects.task_select_target": "Select target project",
  "projects.task_no_other_projects": "No other projects available for transfer",
  "projects.bind_title": "Bindings",
  "projects.bind_skills": "Skills",
  "projects.bind_experts": "Agents",
  "projects.bind_connectors": "Connectors",
  "projects.bind_skills_placeholder": "Search skills…",
  "projects.bind_experts_placeholder": "Search agents…",
  "projects.bind_connectors_placeholder": "Search connectors…",
  "projects.bind_selected": "{count} selected",
  "projects.bind_empty_skills": "No skills available",
  "projects.bind_empty_experts": "No agents available",
  "projects.bind_empty_connectors": "No connectors available",
  "projects.env_local": "Local",
  "projects.env_remote": "Cloud",
  "projects.server_disconnected_hint": "Server disconnected — connector bindings unavailable",

  "devices.synced_count": "{count} devices synced",
  "devices.not_synced": "No devices synced",
  "devices.last_seen": "Last seen {time}",
  "projects.bindings_title": "Bound",
  "projects.bindings_empty": "No bindings",
  "projects.chat_starting": "Connecting to the project assistant…",
  "projects.chat_empty": "When you're ready, tell the project assistant what you want to get done.",
  "projects.chat_needs_workspace": "Connect a workspace to collaborate with the project assistant here.",
  "projects.column_agent": "Agent",
  "projects.column_workspace": "Workspace",
  "projects.column_tasks": "Tasks",
  "projects.workspace_tab_artifacts": "Artifacts",
  "projects.workspace_tab_changes": "Changes",
  "projects.workspace_tab_files": "All files",
  "projects.workspace_empty_artifacts": "No artifacts yet",
  "projects.workspace_empty_changes": "No changes yet",
  "projects.workspace_empty_files": "Connect a workspace to browse files",
  "projects.add_to_chat": "Add to conversation",
  "projects.history": "History",
  "projects.invite_banner": "Invite members to collaborate, or let the agent create tasks, assign members, and start execution from your description.",
  "projects.one_click_generate": "Generate tasks",
  "projects.dialog_create_placeholder": "Describe your idea — the agent creates and runs the matching tasks for you",
  "projects.scope_joined": "Joined",
  "projects.scope_all": "All",
  "projects.updated_at": "Updated {date}",
  "projects.command_placeholder": "Type a command or message… (new task / complete / assign)",
  "projects.command_create_task": "Created task: {title}",
  "projects.command_complete_task": "Completed task: {title}",
  "projects.command_assign_task": "Assigned \"{task}\" to {assignee}",
  "projects.command_switch_plan": "Switched to plan: {title}",
  "projects.command_no_match": "No matching task found",
  "projects.command_no_plan": "Please create a plan first",
  ...
  "screen_recorder.save": "Save Recording",
  "screen_recorder.cancel": "Cancel",
  "screen_recorder.include_audio": "Include Microphone Audio",
  "screen_recorder.select_screen": "Select Screen to Record",
  "screen_recorder.recording": "Recording...",
  "screen_recorder.duration": "Duration: {time}",
  "screen_recorder.preview": "Preview",
  "screen_recorder.permission_denied": "Screen recording permission denied. Please allow access in your browser settings.",
  "screen_recorder.error_starting": "Failed to start recording. Please try again.",
  "screen_recorder.attached": "Recording {name} added to this task",
  ...
  "editor.undo": "Undo",
  "editor.redo": "Redo",
  "editor.link_url_prompt": "Enter URL:",
  "codegen.template_wizard_title": "Create from Template",
  "codegen.template_wizard_description": "Choose a starter template to quickly scaffold your project with best practices and modern tooling",
  "codegen.generating_project": "Generating your project...",
  "codegen.progress_label": "Progress",
  "codegen.step_analyzing_template": "Analyzing template structure",
  "codegen.step_creating_structure": "Creating project structure",
  "codegen.step_generating_files": "Generating files",
  "codegen.step_configuring_dependencies": "Configuring dependencies",
  "codegen.step_finalizing": "Finalizing project setup",

  // Meeting notes extractor
  "meeting.copy_to_clipboard": "Copy to Clipboard",
  "meeting.export_as_markdown": "Export as Markdown",
  "meeting.create_tasks": "Create Tasks",
  "meeting.summary": "Summary",
  "meeting.topics_discussed": "Topics Discussed",
  "meeting.decisions_made": "Decisions Made",
  "meeting.action_items": "Action Items",
  "meeting.due_date": "Due",
  "meeting.no_content_found": "No structured content found in the transcript.",
} as const;
