...
export default {
  ...
  "extensions.add_picker_title": "Add to your Library",
  "extensions.add_picker_hint": "Everything you make lives in your Library and follows you into every workspace.",
  "extensions.add_picker_make": "WHAT ARE YOU MAKING",
  "extensions.add_picker_connect": "OR CONNECT SOMETHING",
  "extensions.add_picker_footer": "You choose who gets it in the last step.",
  "extensions.add_picker_continue": "Continue",
  "extensions.kind_skill": "Skill",
  "extensions.kind_skill_hint": "A way of working the agent picks up on its own.",
  "extensions.kind_command": "Command",
  "extensions.kind_command_hint": "A shortcut you trigger by name in the composer.",
  "extensions.kind_agent": "Agent",
  "extensions.kind_agent_hint": "A specialist you hand a whole job to.",
  "extensions.kind_plugin": "Plugin",
  "extensions.kind_plugin_hint": "Skills, commands and servers bundled together.",
  "extensions.kind_mcp": "MCP server",
  "extensions.kind_mcp_hint": "Point at a server URL you already have.",
  "extensions.kind_connection": "Connection",
  "extensions.kind_connection_hint": "Sign in to something your team already set up.",
  "extensions.kind_connection_badge": "From your org",
  "extensions.add_access_label": "WHO CAN USE IT",
  "extensions.add_access_just_me": "Just me",
  "extensions.add_access_just_me_hint": "Stays in your Library. Nobody else in the org sees it.",
  "extensions.add_access_everyone": "Everyone in the organization",
  "extensions.add_access_everyone_hint": "Shows up in their Library, marked as shared by you.",
  ...
  "placeholder.experts.description": "Experts are agents with an identity and a methodology. Assemble a team of experts so multiple roles can collaborate on your work.",
  "placeholder.projects.description": "Projects gather related tasks, sessions, and files in one place so work stays organized from start to finish.",
  "placeholder.inspiration.description": "Inspiration turns a finished result into a one-click template you can reuse to reproduce the same work.",
