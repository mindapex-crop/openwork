 ...
 * 原文件：qm/src/security/security-posture.ts
 * 移植说明：删除对 ../types.ts 的 OverheardMessage 导入，改为在文件内本地定义最小化的 OverheardMessage 接口（仅保留 SecurityScreenInput 所需的 role/name/text 字段）。其余常量、接口、函数零改动。
 */
