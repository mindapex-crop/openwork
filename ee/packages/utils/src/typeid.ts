...
export const idTypesMapNameToPrefix = {
  ...
  memctx: "mctx",
  tempFile: "tmpf",
  // Team Autonomy (den-autonomy): 多 Agent 团队自治域专用类型 ID
  teamRole: "tmrl",
  teamAgent: "tagt",
  teamBoard: "tbd",
  teamTask: "ttsk",
  teamTaskHandoff: "tho",
  teamArtifact: "tart",
  teamArtifactVersion: "tav",
  teamMailbox: "tmbl",
  teamBudget: "tbg",
  teamBudgetAllocation: "tba",
  teamAutomation: "taut",
  teamAutomationRun: "taur",
  teamAutomationAlert: "taal",
  teamInbox: "tibx",
  teamInboxApproval: "tia",
  teamInboxNotification: "tin",
  teamPermissionProfile: "tpp",
  teamPermissionRule: "tpr",
  teamStandingRule: "tsr",
  skillValidation: "skv",
  skillTestCase: "sktc",
  skillLink: "skl",
} as const
